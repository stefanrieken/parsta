...
// TODO pass any arg beyond r3 on stack! (At least for c callbacks.)
char * regnames[] = { "r6", "r0", "r1", "r2", "r3", "r4", "r5" } ; // NOTE: first reg in this list is for function pointer (if needed)
char * retnames[] = { "r7", "r8", "r9", "r10" } ; // return value appears in r0; then we copy them to one of these.
...
void emit_start(FILE * out) {
    ...
    fprintf(out, ".align 4\n");
    fprintf(out, "args:\n");
    //fprintf(out, "    adrp r7, _top_variables@PAGE\n"); // TODO hijacking an arg register here.
    //fprintf(out, "    add r7, r7, _top_variables@PAGEOFF\n"); // TODO hijacking an arg register here.
